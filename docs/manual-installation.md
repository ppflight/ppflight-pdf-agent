...
日常安装只需[首页的一条命令](../README.md)。本文用于源码开发、手动安装及旧代理维护；命令中的相对路径均从仓库或解压目录执行。
...
## 旧版 Cloudflare Tunnel 的 Nginx 代理维护

以下 Nginx 步骤仅适用于已有旧代理的部署。v1.0.11 一键新安装原生监听 9761，
请按[首页](../README.md)配置 Tunnel，不安装本节的 Nginx，否则会冲突占用端口。
...
sudo ./update.sh --version 1.0.11 \
  ...
  --sha256 5e85012cd5f8c5ac2c14380c703cee058b426d3c6a4639de98d3b67684e94feb
```
...
[protocol.md](protocol.md) 与 [operations.md](operations.md)。
